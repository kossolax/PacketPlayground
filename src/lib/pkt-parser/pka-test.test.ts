...
describe('PKA file test', () => {
  it('should decode debug_connectivity.pka', () => {
    const filepath = join(__dirname, 'samples', 'debug_connectivity.pka');
    ...
    if (xml === null) {
      ...
      console.log('Contains VERSION:', xml.includes('<VERSION>') || xml.includes('VERSION='));
